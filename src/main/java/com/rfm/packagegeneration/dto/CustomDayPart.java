...
public class CustomDayPart {
	
	private Long dataId;
	private String dyptPrdName;
	...
	public String getDyptPrdName() {
		return dyptPrdName;
	}
	public void setDyptPrdName(String dyptPrdName) {
		this.dyptPrdName = dyptPrdName;
	}
