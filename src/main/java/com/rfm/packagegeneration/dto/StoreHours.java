...
public class StoreHours {
	...
	private String restpresentareacode;
	private String restpresentarea;
	private String pricecodeconv;
	...
	public String getRestpresentareacode() {
		return restpresentareacode;
	}
	public void setRestpresentareacode(String restpresentareacode) {
		this.restpresentareacode = restpresentareacode;
	}
	public String getRestpresentarea() {
		return restpresentarea;
	}
	public void setRestpresentarea(String restpresentarea) {
		this.restpresentarea = restpresentarea;
	}
	public String getPricecodeconv() {
		return pricecodeconv;
	}
	public void setPricecodeconv(String pricecodeconv) {
		this.pricecodeconv = pricecodeconv;
	}
