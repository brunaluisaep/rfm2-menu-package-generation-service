...
public class DeliveryOrderingHours {
	...
	private String psntAreaCode;
	
	public String getPsntAreaCode() {
		return psntAreaCode;
	}
	public void setPsntAreaCode(String psntAreaCode) {
		this.psntAreaCode = psntAreaCode;
	}
